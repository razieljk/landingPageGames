  ...
  const GAMES_DATA = [
    {
      ...
      number: "01",
      title: "CruciCode",
      usermanual:"./manuales/crucicode.pdf",
      emoji: "📝",
      accent: "#FFD700",
    ...
    },
    {
      ...
      usermanual:"./manuales/Manual_Millonarios_del_Saber.pdf",
      emoji: "💰",
      accent: "#FF9F00",
...
`,
    ...
    },
    {
      ...
      usermanual:"./manuales/salvaelconocimiento.pdf",
      emoji: "🪢",
      accent: "#00C2FF",
...
`,
      ...
      team: [
        ...
        {
          initials: "YG",
          name: "Cristian Camilo Peña Villa",
          role: "Integrante del equipo",
    ...
    },
    {
      ...
      number: "04",
      title: "EduBingo",
      usermanual:"./manuales/edubingo.pdf",
      emoji: "📚",
      accent: "#00F5FF",
    ...
    },
    {
      ...
      usermanual:"./manuales/esapregunta.pdf",
      emoji: "🤔❓",
      accent: "#7C3AED",
...
`,
      ...
      team: [
        {
          initials: "CR",
          name: "Cesar Augusto Rodas Gutierrez",
          role: "Integrante",
    ...
    },
    {
      ...
      number: "06",
      title: "CardMatch",
      usermanual:"./manuales/cardmatch.pdf",
      emoji: "🃏",
      accent: "#10B981",
...
<div style="display:flex; flex-direction:column; gap:0.6rem; margin-top:0.6rem;">
  ...
  Al finalizar, puedes consultar tus <strong>estadísticas</strong>, revisar tu posición en el <strong>ranking</strong> y ver el historial de tus partidas realizadas.
      ...
      team: [
        {
          initials: "AA",
          name: "Jerson Estiven Bedoya Bedoya",
          role: "Integrante del equipo",
          photo: "./src/img/photos/steven.jpeg",
        },
        {
          initials: "BB",
          name: "Cristoffer Arley Jaramillo Tava",
          role: "Integrante del equipo",
          photo: "./src/img/photos/cristopher.jpeg",
        },
        {
          initials: "CC",
          name: "Diego Fernando Aponte Cardona",
          role: "Integrante del equipo",
    ...
    modal.innerHTML = `
      ...
      <div class="gz-modal-body">
        ...
        <div class="gz-meta-row">
          ...
          <div class="gz-meta-item"> <a target="_blank" href="${game.usermanual}" class="btn btn-primary"> Ver Manual Usuario </a></div>
        </div>
